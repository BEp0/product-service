...
class ProductValidationUnitTest {
    ...
    void allValidations() {
        ProductValidation.fullValidationDTO(new ProductDTO(SKU, PRICE, STORE, QUANTITY, AVAILABLE));
    }
    ...
    void skuNullValidations() {
        ...
        var skuNull = Assertions.assertThrows(ResponseStatusException.class, () ->
                ProductValidation.fullValidationDTO(new ProductDTO(null, PRICE, STORE, QUANTITY, AVAILABLE)));
    ...
    void skuBlankValidations() {
        ...
        var skuBlank = Assertions.assertThrows(ResponseStatusException.class, () ->
                ProductValidation.fullValidationDTO(new ProductDTO("", PRICE, STORE, QUANTITY, AVAILABLE)));
    ...
    void skuWithLettersValidations() {
        ...
        var skuWithLetters = Assertions.assertThrows(ResponseStatusException.class, () ->
                ProductValidation.fullValidationDTO(new ProductDTO("SKU0909", PRICE, STORE, QUANTITY, AVAILABLE)));
    ...
    void skuLowerValidations() {
        ...
        var skuLowerThanMinSize = Assertions.assertThrows(ResponseStatusException.class, () ->
                ProductValidation.fullValidationDTO(new ProductDTO("000", PRICE, STORE, QUANTITY, AVAILABLE)));
